...
const RADII = new Set([
  0, 3, 6, 8.5, 12.75, 17,
  // 25.5 — геройская иконка онбординга и семейного экрана, 85×85. Элемент
  // такого масштаба в приложении один, пары у него нет.
  25.5,
  // 27.2 — верх нижнего шита. Тоже единственный в своём роде.
  27.2,
]);
