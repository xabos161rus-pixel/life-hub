...
export function Sheet({ open, onClose, title, children }: Props) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-x-0 bottom-0 max-h-[88dvh] animate-sheet-up overflow-y-auto rounded-t-2xl border-t border-border bg-surface pb-[calc(env(safe-area-inset-bottom)+16px)]">
        <div className="sticky top-0 z-10 bg-surface px-4 pt-2.5 pb-2">
