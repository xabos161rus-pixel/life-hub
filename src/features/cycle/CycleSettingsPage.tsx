        ...
        <section>
          ...
          <div className="card divide-y divide-hairline px-4">
            ...
            <ToggleRow
              ...
              hint="Показывает, как отметки энергии распределяются по дням цикла. Только твои числа, без выводов и советов."
          ...
          <p className="mt-2 px-1 text-xs leading-snug text-muted">
            Приложение не будет подстраивать за тебя план дня, тренировки или задачи под фазу
