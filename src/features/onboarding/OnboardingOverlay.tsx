...
const SLIDES: { icon: LucideIcon; title: string; text: string }[] = [
  ...
  },
  {
    ...
    text: isTouch
      ? 'Быстрый ввод одной строкой: «завтра в 10 позвонить маме» — дата и время распознаются сами. Свайп по задаче вправо — выполнить, влево — перенести или удалить, удержание — перетащить в другой проект. А кнопку «+» удержанием можно перенести в удобное место на экране.'
      : 'Быстрый ввод одной строкой: «завтра в 10 позвонить маме» — дата и время распознаются сами, Enter добавляет задачу. Потяните задачу мышью вправо — выполнить, влево — перенести или удалить. А кнопку «+» удержанием можно перенести в удобное место на экране.',
  },
  {
    icon: NotebookText,
    title: 'Заметки',
