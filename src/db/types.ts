...
export interface Settings {
  ...
  // Раскладка навигации «под себя»: какие разделы в нижней панели (bottom, по
  // порядку, без якоря «Ещё») и какие спрятаны (hidden). Строки-id из
  // lib/sections. undefined — раскладка по умолчанию. Device-local, нормализуется
  // через computeNavLayout (битый конфиг не ломает навигацию).
  navConfig?: { bottom: string[]; hidden: string[] };
