...
export const EN: Record<string, string> = {
  ...
  'вчера': 'yesterday',
  '{d} дн назад': '{d} d ago',
  'Удалить сообщение? Оно исчезнет у всех.': 'Delete this message? It will disappear for everyone.',
  'Файл ещё не получен целиком — подождите пару секунд': 'The file has not fully arrived yet — give it a couple of seconds',
  'Проведите по сообщению вправо — ответить': 'Swipe a message right to reply',
  'Двойное касание — быстрое ❤️': 'Double-tap for a quick ❤️',
  'Касание или удержание — меню: реакции, копировать, править': 'Tap or hold for the menu: reactions, copy, edit',
  '{name} теперь в группе': '{name} is now in the group',
  ...
  'ч': 'h',
  '↑{max}° ↓{min}°': '↑{max}° ↓{min}°',
  'ощущается {feels}°': 'feels like {feels}°',
  'Сообщения': 'Messages',
  'Звонки': 'Calls',
  'Копии и восстановление': 'Backups & restore',
  'нет копии': 'no backup',
  'Показать заново': 'Show again',
  'Установка и восстановление': 'Install & restore',
  'включено': 'on',
  'выключено': 'off',
  'Резервные копии': 'Backups',
  'Копия файлом': 'File backup',
  'Автоматическая копия': 'Automatic backup',
